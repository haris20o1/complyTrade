...
//   if (!authChecked || (isLoading && !userRole)) {
//     return (
//       <div className="bg-slate-900 text-white w-64 flex flex-col h-screen">
...
//   return (
//     <div 
//       className={`bg-slate-900 text-white transition-all duration-300 ${expanded ? 'w-64' : 'w-20'} flex flex-col h-screen`}
//       data-testid="sidebar"
//     >
//       {/* Header with Logo and Toggle Button */}
...
//         <button 
//           onClick={() => setExpanded(!expanded)} 
//           className="text-white p-1 hover:bg-slate-800 rounded-md"
//           aria-label={expanded ? "Collapse sidebar" : "Expand sidebar"}
//           data-testid="sidebar-toggle"
//         >
//           {expanded ? (
