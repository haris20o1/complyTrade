...
const VesselTrackingPage2 = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-3/4 right-1/4 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-2000"></div>
          <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-4000"></div>
        </div>
        
        <div className="text-center z-10 px-8">
          <div className="mb-8 animate-bounce">
            <Ship size={80} className="text-white mx-auto mb-4" />
          </div>
          <h1 className="text-5xl font-bold text-white mb-4 tracking-tight">
            Vessel Tracking System
          </h1>
          <p className="text-xl text-blue-200 mb-12 max-w-2xl mx-auto leading-relaxed">
            Real-time maritime vessel monitoring with advanced navigation data and route visualization
          </p>
          <button
            onClick={handleButtonClick}
            className="group relative inline-flex items-center justify-center px-12 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 hover:from-blue-500 hover:to-indigo-500"
          >
            <Activity className="mr-3 h-6 w-6 group-hover:animate-pulse" />
            Track Vessel
  ...
  return (
    <div className={`min-h-screen bg-gray-50 transition-all duration-1000 ${animateIn ? 'opacity-100' : 'opacity-0'}`}>
      {/* Header */}
      ...
      <div className="flex flex-col lg:flex-row h-[calc(100vh-80px)]">
        {/* Map Section */}
        <div className={`w-full lg:w-2/3 h-1/2 lg:h-full bg-white shadow-lg transition-all duration-700 transform ${animateIn ? 'translate-x-0' : '-translate-x-full'}`}>
          <MapContainer 
            ref={mapRef}
            center={[35, 100]} 
            zoom={4} 
        ...
        {/* Details Section */}
        <div className={`w-full lg:w-1/3 h-1/2 lg:h-full bg-white shadow-lg overflow-hidden transition-all duration-700 transform ${animateIn ? 'translate-x-0' : 'translate-x-full'}`}>
          {/* Tab Navigation */}
...
export default VesselTrackingPage2;