            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="flex justify-between items-center p-4 border-b border-gray-200">
                ...
                <div className="flex space-x-2">
                  ...
                  <button 
                    ...
                    disabled={completedLCs.length === 0}
                  >
              ...
              {completedLCs.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Completed Letters of Credit</h3>
                  <p className="text-gray-500 max-w-md mx-auto">
                    There are currently no completed Letters of Credit to display. Completed LCs will appear here once processing is finished.
                  </p>
                </div>
              ) : (
                /* Data Table */
              ...
              {totalPages > 1 && completedLCs.length > 0 && (
